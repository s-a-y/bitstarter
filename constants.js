...
*/
var Constants = {
  APP_NAME: "Spend-a-bit.com", 
  FUNDING_TARGET: 50.00,
  FUNDING_UNIT_SYMBOL: "BTC",
  FUNDING_SI_SCALE: 1000,
  FUNDING_END_DATE: new Date("September 28, 2013"),
  PRODUCT_NAME: "Spend-a-bit: Development Version",
  PRODUCT_SHORT_DESCRIPTION: "Stop saving your bitcoins, spend a bit!",
  TWITTER_USERNAME: "spend_a_bit",
  TWITTER_TWEET: "This student crowdfunder looks interesting.",
  COINBASE_PREORDER_DATA_CODE: "80cfe98b69300ea1a7dabff41897a02f",
  days_left: function() {
